...
namespace MyAssessment.Services
{
    public class DatabaseSeeder
    {
        ...
        private async Task SeedMapelAsync()
        {
            ...
            {
                new MapelItem { Nama = "Matematika" },
                new MapelItem { Nama = "Fisika" },
                new MapelItem { Nama = "Kimia" },
                new MapelItem { Nama = "Biologi" },
                new MapelItem { Nama = "Bahasa Indonesia" },
                new MapelItem { Nama = "Bahasa Inggris" },
                new MapelItem { Nama = "Bahasa Jepang" }
            };
